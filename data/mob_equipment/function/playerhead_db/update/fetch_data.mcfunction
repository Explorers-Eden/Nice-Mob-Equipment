$data remove storage eden:playerhead_db entries.$(id)
...
$data modify storage eden:playerhead_db entries.$(id) set from entity @n[type=item,nbt={Item:{id:"minecraft:player_head",components:{"minecraft:custom_data":{mob_equipment:playerhead_db_$(id)}}}}] Item.components.minecraft:profile
