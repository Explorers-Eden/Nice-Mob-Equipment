...
execute if score $eden.legs.type eden.technical matches 61..65 run data modify entity @s ArmorDropChances[1] set value 0.000F
execute if score $eden.legs.type eden.technical matches 66..67 run data modify entity @s ArmorDropChances[1] set value 0.000F