...
execute if predicate eden:percentages/50 if items entity @s weapon.mainhand minecraft:fishing_rod run function mob_equipment:offhand/fishing_rod with storage mob_equipment:offhand
...
execute if predicate eden:percentages/50 if items entity @s weapon.mainhand #minecraft:swords run function mob_equipment:offhand/swords_axes with storage mob_equipment:offhand
execute if predicate eden:percentages/50 if items entity @s weapon.mainhand #minecraft:axes run function mob_equipment:offhand/swords_axes with storage mob_equipment:offhand
